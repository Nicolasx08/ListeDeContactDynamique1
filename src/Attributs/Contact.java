...
public class Contact {
    ...
    public void modifierContact(){
        ...
        boolean ok= false;
        Scanner sc =new Scanner(System.in);
        System.out.println("Votre contact s'appelle: "+ nom);
        input=sc.nextLine().trim();
        input=sc.nextLine().trim();
        if (!input.equals("")){
            setNom(input);
        }
        System.out.println("Votre contact s'appelle: "+ nomDeFamille);
        input=sc.nextLine().trim();
        if (!input.equals("")){
        ...
        while (!ok){
            System.out.println("Voulez-vous entrer un nouveau numéro de téléphone?");
